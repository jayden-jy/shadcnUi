...
export default function SingUp() {
  ...
  const [privacyAgreed, setPrivacyAgreed] = useState<boolean>(false); // 개인정보 수집 및 이용양관 동의 여부
  ...
  return (
    <main className="w-full h-full min-h-[720px] flex items-center justify-center p-6 gap-6">
      <div className="w-100 max-2-100 flex flex-col px-6 gap-6">
              ...
              <div className="w-full flex flex-col gap-3">
                <div className="flex items-center gap-2">
                  ...
                  <Button
                    type="submit"
                    variant={"outline"}
                    className="py-1 flex-1 !bg-sky-800/50"
                  >
                    회원가입
                  </Button>
                </div>
